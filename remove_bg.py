...
from main_startup.core.decorators import Tezer_on_cmd, listen
...
async def rmbg(client, message):
    ...
    if "image" in contentType:
        ...
        await pablo.edit(
            "Removed image's Background in {} seconds, powered by @TezerOT".format(ms)
        )
    else:
        await pablo.edit(
            "ReMove.BG API returned Errors. Please report to @TezerOT\n`{}".format(
