...
@Tezer_on_cmd(
    ...
    is_official=False,
    cmd_help={
        "help": "Automatically Gets Streaming Link Of The Anime. Get Site names list from Here : https://TeamTezeranime.netlify.app",
